  ...
  useEffect(() => {
    const fetchMatchedUsers = async () => {
      ...
      try {
        ...
        setError('An error occurred while fetching your matches. Please try again later.');
      } finally {
        setIsLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-400 to-red-500 flex items-center justify-center">
        <div className="bg-white p-8 rounded-2xl shadow-xl flex flex-col items-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800">Finding your matches...</h2>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-400 to-red-500">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start mb-8">
          ...
          <div>
            <h3 className="font-medium text-amber-800">Qoupled Compatibility</h3>
            <p className="text-sm text-amber-700 mt-1">
              Our proprietary algorithm calculates compatibility based on personality traits and preferences. 
              Results may vary and are intended as a starting point for meaningful connections.
            </p>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    <label className="block text-sm font-medium text-gray-700">
                      Compatibility Range: {compatibilityRange[0]}% - {compatibilityRange[1]}%
                    </label>
                    <div className="relative pt-1">
                      <input
                        ...
                        onChange={(e) => setCompatibilityRange([parseInt(e.target.value), compatibilityRange[1]])}
                      ...
                      <input
                        ...
                        onChange={(e) => setCompatibilityRange([compatibilityRange[0], parseInt(e.target.value)])}
                        className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                      />
                  ...
                  <div>
                    <div className="flex items-center mt-3">
                      <label className="inline-flex items-center cursor-pointer">
                        ...
                        <span className="ms-3 text-sm font-medium text-gray-700">Show Qoupled Compatibility Only</span>
                      </label>
                    </div>
                    <p className="text-xs text-gray-500 mt-2 ml-14">
                      Filter to show only profiles that match your personality type
                    </p>
                  </div>
                </div>
          ...
          {filteredUsers.length === 0 ? (
            <div className="bg-white rounded-xl shadow-md p-8 text-center">
              ...
              <p className="text-gray-500 max-w-md mx-auto">
                Try adjusting your filters or search criteria to find more potential matches.
              </p>
              <button
                onClick={resetFilters}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredUsers.map(user => (
                <div key={user.id} className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center mb-4">
                      <div className={`h-10 w-10 rounded-full flex items-center justify-center mr-3 ${
                        user.compatibility >= 80 ? 'bg-green-100 text-green-600' :
                        user.compatibility >= 65 ? 'bg-blue-100 text-blue-600' : 
                      ...
                      <div>
                        ...
                        <div className={`text-lg font-semibold ${
                          user.compatibility >= 80 ? 'text-green-600' :
                          user.compatibility >= 65 ? 'text-blue-600' : 
                          'text-amber-600'
                        }`}>
                          {user.compatibility}%
                        </div>
